...
# Help message
usage() {
    echo "SLURM submission script for job with CPU and GPU tasks. Use to run any bash script."
    echo "Usage: $0 [-s script_path] [-j job_name] [-p partition] [-a account] [-g gpus] [-c cpus_per_task] [-m mem] [-t time] [-o output]"
    echo "Options:"
