...
# Help message
usage() {
    echo "SLURM submission script for array jobs with CPU only tasks. Use to run any bash script in parallel."
    echo "Usage: $0 [-s script_path] [-j job_name] [-p partition] [-a account] [-c cpus_per_task] [-m mem] [-t time] [-o output] [-n num_array] [-x concurrency]"
    echo "Options:"
